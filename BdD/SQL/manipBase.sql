...
--Noms des sous-sections dont le nom est utlisé deux fois mais dans 2 sections différentes ?
...
--Liste des sujets de MP où 2 personnes (pseudo1 et pseudo2) apparaissent obligatoirement ?
...
-- Combien de commentaire a écrit toutes les personnes inscrites, toute news confondues ?
...
-- Parmi les personnes ayant écrit un message dans ce sujet, lesquels sont modérateurs ?
SELECT pseudo, nomGroupe FROM Appartient
