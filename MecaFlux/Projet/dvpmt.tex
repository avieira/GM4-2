...
\begin{figure}[!h]
\centering
\includegraphics[scale=0.4]{resultsCx/force_rem1.png}
...
Ainsi, on réalise une nouvelle fois que ce tourbillon participe une nouvelle fois au mouvement avec une force tangentielle positive sur le "toitremorque".
\begin{figure}[!h]
\centering
...
Au vu des 4 récapitulatifs de forces, à vitesse égale, on peut établir un ordre pour les différentes remorques, de celle qui induit le moins de forces contraires au mouvement à la moins aérodynamique:
..
..
..
..
